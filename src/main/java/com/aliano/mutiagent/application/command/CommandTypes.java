...
public final class CommandTypes {
    ...
    public static final String WORKSPACE_DISPATCH_CREATE = "workspace.dispatch.create";
    public static final String WORKSPACE_DISPATCH_EXISTING = "workspace.dispatch.existing";
    public static final String SUMMARY_APPLY = "summary.apply";
